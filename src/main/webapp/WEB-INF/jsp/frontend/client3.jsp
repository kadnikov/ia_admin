...
<div class="wrapper" ng-cloak class="ng-cloak" ui-layout class="layout-mock">
  <header class="north-back" style="height:50px;">
...
<ui-layout options="{ flow : 'column' }" class="main-content container-fluid">
</ui-layout>
<footer ng-cloak class="ng-cloak south-back" style="height:50px;">
    <div growl></div>
